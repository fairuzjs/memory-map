        ...
        return (
            <motion.div custom={2} variants={fadeUp} initial="hidden" animate="show" className="text-center">
                ...
                <Link href="/forgot-password"
                    className="inline-flex items-center gap-2 text-sm font-black text-black px-6 py-3 border-[3px] border-black bg-[#67e8f9] shadow-[4px_4px_0_#000] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0_#000] transition-all rounded-xl">
                    Minta tautan baru
                </Link>
            </motion.div>
        )
