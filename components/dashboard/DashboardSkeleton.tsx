...
export function DashboardSkeleton() {
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full space-y-8 pb-32">
            ...
            {/* ── Hero Skeleton ─────────────────────────────────────────────────────── */}
            <div className="relative p-6 sm:p-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 bg-[var(--mm-bg)] border-[3px] border-[var(--mm-border)] shadow-[5px_5px_0_var(--mm-shadow)] rounded-3xl">
            ...
            <div className="space-y-4">
                ...
                <div className="bg-[var(--mm-surface)] border-[3px] border-[var(--mm-border)] shadow-[5px_5px_0_var(--mm-shadow)] rounded-3xl grid grid-cols-2 sm:flex divide-y-[3px] sm:divide-y-0 sm:divide-x-[3px] divide-[var(--mm-border)] overflow-hidden">
                    {[1, 2, 3, 4].map((i) => (
            ...
            <div className="space-y-4">
                ...
                <div className="flex flex-col lg:flex-row gap-6">
                    {/* Heatmap Skeleton */}
                    <div className="flex-1 bg-[var(--mm-surface)] border-[3px] border-[var(--mm-border)] shadow-[5px_5px_0_var(--mm-shadow)] rounded-3xl p-6 space-y-6">
                    ...
                    {/* Calendar Skeleton */}
                    <div className="w-full lg:w-[360px] bg-[var(--mm-surface)] border-[3px] border-[var(--mm-border)] shadow-[5px_5px_0_var(--mm-shadow)] rounded-3xl p-6 space-y-5">
